...
const formatsSpecs = {
    ...
    fontFamily: {
        isFormatted: isFontFamily,
        hasStyle: (node) => node.style && node.style['font-family'],
        addStyle: (node, props) => node.style['font-family'] = props.family,
...
export function isFontFamily(node, props) {
    const element = closestElement(node);
    return getComputedStyle(element)['font-family'] === props.family;
}
/**
